...
CSV_PATH = "./random_line_push_waypoints/3661073676/random_line_robodk_joints.csv"
OUT_DIR = Path("./random_line_push_waypoints/3661073676/mujoco_random_line_results")
