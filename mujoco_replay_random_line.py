...
CSV_PATH = "./random_line_push_waypoints/3666223592/random_line_robodk_joints.csv"
OUT_DIR = Path("./random_line_push_waypoints/3666223592/mujoco_random_line_results")
